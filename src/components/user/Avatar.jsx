...
function Avatar({ size = "xl", url = "" }) {
  ...
  return (
    <div
      className={clsx(
        "inline-flex justify-center items-center  rounded-full bg-black/50 relative overflow-hidden",
        getSize()
      )}
    >
      {url !== "" ? (
        <img src={url} className="absolute text-indigo-500 h-full w-full"></img>
      ) : (
